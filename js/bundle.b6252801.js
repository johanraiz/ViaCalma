...
function render__onboarding(root, params) {
  ...
  if (step.id === "respiration") {
    inner += `
      <div class="breath-wrap"><div class="breath-circle is-idle" id="breathCircle"><span class="breath-label" id="breathLabel">Commencer</span></div></div>
...
function renderLevel1(root, slug, level) {
  root.innerHTML = `
    <div class="screen">
      ...
      <div class="curve-wrap is-idle" id="curveWrap">
...
function renderLevel2(root, slug, level) {
  root.innerHTML = `
    <div class="screen">
      ...
      <div class="heart-wrap"><div class="heart-circle is-idle" id="heartCircle"><span class="heart-label" id="labelC">Commencer</span></div></div>
  ...
  root.innerHTML = `
    <div class="screen">
      ...
      <div class="bubble-wrap">
        <div class="bubble is-idle" id="bubbleEl" style="background: radial-gradient(circle at 35% 30%, ${color.from}, ${color.to});">
  ...
  root.innerHTML = `
    <div class="screen">
      ...
      <div class="mantra-wrap">
        <div class="mantra-circle is-idle" id="mantraCircle"><span class="mantra-txt" id="mantraTxt">Commencer</span></div>
      </div>
