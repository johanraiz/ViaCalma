...
// v1.95 — à la demande de Johan : le cercle de respiration (utilisé ici et dans detresse.js, qui
// partage cette même fonction) ne démarre plus tout seul. Il reste au repos ("Commencer", pas
// d'animation) jusqu'au premier toucher, avec la consigne "toucher pour commencer l'exercice" —
// voir le commentaire détaillé dans js/screens/outil-respiration.js, où la même règle est posée
// pour les 3 niveaux de l'outil dédié.
let breathRaf = null;
...
// détail de l'avis donné). "lent" = chaque temps dure 25% de plus (1250ms), "rapide" = 20% de moins
// (800ms), "normal" = comportement d'origine (1000ms) inchangé. Seule la durée change, jamais le
// comptage (toujours 4-4-4, etc.) — le protocole reste le même, juste plus ou moins étiré dans le
// temps.
...
// "toucher pour commencer l'exercice", cf. v1.95) — une fois lancé, le choix reste figé pour ne pas
// complexifier l'exercice en cours de route ; il sera repris tel quel à la prochaine visite.
...
// Expire (il alterne deux phrases toutes les 4 secondes), il invite lui aussi à respirer
// ("Respire avec moi") et pulse tout seul dès l'affichage — Johan a confirmé vouloir le même
// geste "toucher pour commencer" que sur les exercices de respiration à proprement parler
// (cf. js/screens/outil-respiration.js pour le détail de la décision).
let mantraRaf = null;
...
// v1.95 : cet écran réutilise startBreathAnim/stopBreathAnim (définies dans onboarding.js — même
// bundle) et donc, depuis v1.95, le même geste "toucher pour commencer" plutôt qu'un démarrage
// automatique. Particulièrement pertinent ici : c'est l'écran de respiration proposé en pleine
// détresse quand aucun outil n'a encore été noté (cf. pickHistoryRedirect ci-dessus).
